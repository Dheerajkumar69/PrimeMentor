...
                        // Fallback handling in case image URL is broken
                        onError={(e) => { e.target.onerror = null; e.target.src=`data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 width=%2740%27 height=%2740%27%3E%3Crect width=%2740%27 height=%2740%27 fill=%27%235c6bcf%27 rx=%2720%27/%3E%3Ctext x=%2750%25%27 y=%2760%25%27 font-family=%27Arial%27 font-size=%2716%27 font-weight=%27bold%27 text-anchor=%27middle%27 fill=%27white%27%3ET%3C/text%3E%3C/svg%3E`; }}
                    />
